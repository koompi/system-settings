...
pub mod buttons {
   use iced::{button, Color, Background, Vector};
...
pub mod progressbar {
   use iced::{progress_bar, Color, Background};
...
pub mod picklist {
   use iced::{pick_list::{self, Menu}, Color, Background};
...
pub mod sliders {
   use iced::{slider::{self, Handle, HandleShape}, Color, Background};
   pub enum SliderStyle {
      Default,
      Circle,
   }
